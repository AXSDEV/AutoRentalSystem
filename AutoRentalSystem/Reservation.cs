...
namespace AutoRentalSystem
{
	...
	public void CalculatePrice(decimal baseDailyPrice)
	{
		...
		this.TotalPrice = totalDays * baseDailyPrice;
    }

	public override string ToString()
	{
		return $"Reservation ID: {Id}, Vehicle: {Vehicle}, Start Date: {StartDate.ToShortDateString()}, End Date: {EndDate.ToShortDateString()}, Total Price: {TotalPrice:C}, Completed: {IsCompleted}";
    }
